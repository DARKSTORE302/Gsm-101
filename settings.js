...
global.botname = "GSM-MD BOT" 
global.botLanguage = "default" // 𝗗𝗲𝗳𝗮𝘂𝗹𝘁 || 𝗘𝗻𝗴𝗹𝗶𝘀𝗵 || 𝗛𝗶𝗻𝗱𝗶 || 𝗔𝗿𝗮𝗯𝗶𝗰 \\
global.author = "𝙋𝙄𝙆𝘼"  
global.packname = "TEAM DARK ®"  
global.myweb = "https://github.com/DARKSTORE302" // You can put any link 
global.waterMark = "×͜× King ✘ Pika™ ✓" // Your own watermark 
global.headerText = "GSM BOT" // text for header of menu         
global.DocumentTitle = "TEAMxDARK" 


global.ownername = "GSM ATIQUE"   // Owner name //        
global.ownernumber = ['923432680285'] 
global.socialm = "𝗜𝗻𝘀𝘁𝗮 : GSM_ATIQUE" // 𝗜𝗻𝘀𝘁𝗮 : || 𝗚𝗶𝘁𝗵𝘂𝗯 : || 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸 : \\
global.ytname = "YT: TEAM DARK OFFICIAL"   // Yt chanel name //
global.continent = "Asia" // your continent name 
global.region = "Pakistan" // your country name
global.state = "Punjab" // your state name
global.district = "Sargodha" // your district name
global.timezone = "Asia/Islamabad" // search on google if you don't know the timezone of your country //
global.instagramId = "GSM_ATIQUE" // Your insta ID
global.email = "gsmtechnicalyt@gmail.com" // put your email here


//------------ 🌟 Premium Users 🌟-------------\\
global.premium = ['923432******','923460******']  // available soon
global.sudo = ['923060******','923137******']  // Co - Owners //

global.prefa = ['-','🥵','🔥']

//--------Random bot name for Info section--------\\
name16 = "𓄂⍣⃝ 🇦TIQUE V1 BOT"
name17 = "*Λ⃝ͷ🇾Λ 𓆩×͜×𓆪ꪾ*"
name18 = "*Λ⃝ͷʏΛ 𓆩×͜×𓆪ꪾ*"

//--------Random footer message-----------\\
footer1 = `𓄂⍣⃝🇦TIQUE V1 BOT`
